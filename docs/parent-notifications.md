...
![Subscriptions page with Subscribe to notifications button](assets/3_allow-notifications.png)

Your browser will ask for permission to show notifications. Click **Allow**.

![Browser permission prompt asking to show notifications from portal.morgantondayschool.com](assets/4_browser-confirmation.png)
...
![Class selection list with checkboxes and Save Subscriptions button](assets/5_select-classes.png)
